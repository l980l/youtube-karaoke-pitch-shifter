...
- ⚡ **마스터 전원 ON / OFF 스위치**: 확장 프로그램을 켜고 끌 수 있는 원클릭 토글 스위치 (꺼짐 시 100% 원곡 상태 및 UI 비활성화)
- ⌨️ **단축키 완전 사용자 지정(Custom Key Binding)**: 팝업의 [⚙️ 단축키 설정] 탭에서 원하는 모든 키(단일 키, 조합 키 등)로 손쉽게 변경 가능
...
| **오버레이 리모콘 켜기/끄기** | `Alt + M` | 화면 내 리모콘을 표시하거나 숨깁니다 |
